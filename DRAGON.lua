...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/Offline/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751768178,1304868679,1614314857,1970207619,1743756832,}   
...
var = true  
elseif tonumber(user_id) == tonumber(1970207619) then
var = true 
...
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير نور عيني'  
elseif database:sismember(bot_id..'S00F4:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
...
os.execute('wget https://raw.githubusercontent.com/Gold-So/Offline/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ♽︙ اصدار سورس جولد { s: 6.7}')
end
...
if text =='تغير المطور الاساسي' and not SudoBot(msg) then
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/GI63H"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/Dv_Gold"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&Photo=https://t.me/aslak8/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ♽︙ العضو : {["..data.first_name_.."](t.me/GI63H)}\n ♽︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♽︙ عذرا ↫ {["..data.first_name_.."](t.me/GI63H)}\n ♽︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
 ⚘ اهلا بك في سورس جولد الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ⚘ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᯓ˹ ᴊᴀᴠᴀ ᴇʟʜᴀᴋᴇʀ˼𖠱',url="t.me/amr_java"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عبدالله' or text == 'بودي' or text == 'مطور السورس2' then
local Text = [[
مطور سورس جولد
]]
keyboard = {} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ✅', url="t.me/GI63H"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == '☯︎ 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 𝗚𝗼𝗹𝗱 ☯︎' then
local Text = [[ 
قناه مطورين السورس 🌐
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=http://t.me/GI63H/4/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب جولد' or text == 'العاب مطوره' or text == 'الالعاب' then  
local Text = [[  
...
elseif text == 'قفل جولدرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح جولدرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1970207619) then  
send(msg.chat_id_, msg.id_, " ♽︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ♽︙ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or '@GI63H')..')'
...
if result.id_ == tonumber(1970207619) then
send(msg.chat_id_, msg.id_, " ♽︙ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ♽︙ العضو ↫ ['..result.title_..'](t.me/'..(username or '@GI63H')..')'
...
if tonumber(userid) == tonumber(1970207619) then  
send(msg.chat_id_, msg.id_, " ♽︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/Offline/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♽︙ اهلا بك في متجر ملفات جولد\n ♽︙ ملفات السورس ↓\n•━═━═━═『ɢᴏʟᴅ』═━═━═━•\n\n"
local TextE = "\n•━═━═━═『ɢᴏʟᴅ』═━═━═━•\n ♽︙ علامة تعني { ✔️ } ملف مفعل\n ♽︙ علامة تعني { ✖ } ملف معطل\n ♽︙ قناة سورس جولد ↓\n".." ♽︙ [اضغط هنا لدخول](t.me/GI63H) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/Offline/main/File_Bot/"..file)
if res == 200 then
...
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local GI63H = database:get(bot_id..'text:ch:user')
if GI63H then
send(msg.chat_id_, msg.id_,'['..GI63H..']')
else
send(msg.chat_id_, msg.id_,' 🕊 لا تستطيع استخدام البوت \n  🕊 يرجى الاشتراك بالقناه اولا \n  🕊 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
end --الكود حصري سورس جولد يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/GI63H)') 
return false
end
...
if text == 'اطردني' or text == 'طالعني' and GetChannelMember(msg) then   
if not database:get(bot_id..'Cick:Me'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,'[\n࿕ ¦•𝐮𝐬𝐞𝐫   '..username..'↝🇧🇷\n࿕ ¦•𝐦𝐬𝐠  '..Msguser..'↝🇧🇷\n࿕ ¦•𝐬𝐭??  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'↝🇧🇷\n࿕ ¦•𝐢𝐝 '..msg.sender_user_id_..'↝🇧🇷\n࿕ ¦•𝗖𝗛t.me/GI63H↝🇧🇷\n')
end
end
...
{
{text = 'ՏOᑌᖇᑕᗴ ᘜOᒪᗪ', url="t.me/GI63H"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
