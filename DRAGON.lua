...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/Gold-So/Elgmden/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/Gold-So/Elgmden/DRAGON.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' :̤̈Ö̤::̤̈S̤̈::̤̈Ö̤::̤̈S̤̈:',url="t.me/OSDDR"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ':̤̈T̤̈::̤̈Ä̤::̤̈Ḧ̤::̤̈Ä̤:',url="t.me/Xxx_ksomk_xxX"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/Gold-So/Elgmden/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/Gold-So/Elgmden/File_Bot/"..file)
if res == 200 then
...
local json_file, res = https.request("https://hubusercontent.com/Ffasit/Gold-So/Elgmden/File_Bot/"..file)
if res == 200 then
