...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/Gold-So/classic/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,859213488,188313077,1770739933,1763213425,188313077}   
...
local UserName = (data.username_ or "uu_regan")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》")  
...
local Text = ' 〠تم ارسال الملصق من 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/Gold-So/classic/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/uu_regan/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ريجان ادخل وتابع الجديد](t.me/uu_regan)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》', url="t.me/uu_regan"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_regan/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ريجان ادخل وتابع الجديد](t.me/uu_regan)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/uu_regan)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/uu_regan"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," 〠 الـعـضو  : {["..data.first_name_.."](T.ME/uu_regan)}\n 〠 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 〠 عذرا  ⇇{["..data.first_name_.."](T.ME/uu_regan)}\n 〠 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
المبرمج محمد ابراهيم لو حابب تتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃₎ •𖣘❩',url="t.me/mo1ibrahim"}},
...
local Text = [[ 
مطورين ومبرمجين سورس ريجان اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/SAYTRA55"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == "تصميم ريجان" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,3); 
local Text ='تم اختيار تصميم من تصميمات ريجان هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃₎ •𖣘 ❩', url="t.me/mo1ibrahim"}},
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》',url="t.me/uu_regan"}},
...
〠 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
〠 𝘾𝙃 - [《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》](t.me/uu_regan) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃₎ •𖣘 ❩', url="t.me/mo1ibrahim"}},
{{text = '❨  𖣘• ⁽𝚅𝙸𝙺𝙸𝙽𝙶₎ •𖣘 ❩', url="t.me/uu_regan"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/uu_regan/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/uu_regan)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
function(arg,data) 
usertext = '\n 〠 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'uu_regan')..')'
...
usertext = '\n 〠 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'uu_regan')..')'
status  = '\n 〠 تم حظرو عام من الجروبات '
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/Gold-So/classic/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 〠 اهلا بك في متجر ملفات ريجان\n 〠 ملفات السورس 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n 〠 علامة تعني { ✔️ } ملف مفعل\n 〠 علامة تعني { ✖ } ملف معطل\n 〠 قناة سورس ريجان𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n".." 〠 [اضغط هنا لدخول](t.me/uu_regan) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/Gold-So/classic/main/File_Bot/"..file)
if res == 200 then
...
' }\n'..' 〠  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 〠  الرفع  ⇇{ '..setadd..
' }\n'..' 〠  الحظر  ⇇{ '..banm..' }\n\n 〠═───═❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》 ](t.me/uu_regan)❳═───═ 〠\n 〠 قناة سورس ريجان𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\n [ ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》 ](t.me/uu_regan)❳](t.me/uu_regan) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘ٴ\n 〠 ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》 ](t.me/uu_regan)❳ 〠 ')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/uu_regan/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/uu_regan/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/uu_regan/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..〠♥️](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/uu_regan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤〠](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..〠💕](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/uu_regan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..〠💕](t.me/uu_regan)')
return false
end
end
end
...
[[
↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 〠  
↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast 〠  
↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs 〠  
↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@uu_regan↜ 〠  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝐑𝐄𝐆𝐀𝐍⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》 ](t.me/uu_regan)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》 ](t.me/uu_regan)❳ 
]]
keyboard = {} 
